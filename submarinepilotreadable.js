/*
    This is the slightly more readable version of my submarinepilot script.
*/
...
// Controls movement of all mines moving left
...
// Allows player to land on mines
function collisionMine() {
    var i = 0;
    while (i < mines.length) {
        // If the player collides with a mine...
        ...
        while (j < projectiles.length) {
            ...
            // If a projectile collides with a mine...
